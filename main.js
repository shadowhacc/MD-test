...
global.channelLink = "https://whatsapp.com/channel/0029Vb7CCmzAu3aVUSEFw93z";
global.ytch = "https://youtube.com/@shadowhere.460?si=94wLwhGCjjTJXtjx";
...
async function handleMessages(sock, messageUpdate, printLog) {
  ...
  // Har message ke liye auto-react
if (!message.key.fromMe) {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7CCmzAu3aVUSEFw93z'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/HqgyTAHeteM6bBUfIx7x8V?mode=gi_t`
                }, { quoted: message });
                return;
            }
        }
    ...
    case userMessage.startsWith('.animu'): {
        const args = userMessage.slice(6).trim().split(/\s+/);
    ...
    case userMessage.startsWith('.pair'): {
        ...
        const numberArg = userMessage.slice(5).trim();
        await pairCommand(sock, chatId, message, numberArg);
        break;
    }
